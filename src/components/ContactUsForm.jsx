...
import { renderFormGroupField, renderFormTextArea, renderFormCheckbox} from "../helpers/renderForm";
import { required, maxLength50, nameValidation, maxLengthMobileNo, minLengthMobileNo,
  digit, emailValidation, maxLength1000,} from "../helpers/validation";
      ...
      <div className="row">
        <div className="col-md-6">
          <Field
            ...
            icon={IconPerson}
            required={true}
            validate={[required, maxLength50, nameValidation]}
            pattern="[a-zA-Z\s]*"
            maxLength="50"
            className="mb-3"
          />
