export const data = {
  banner: [
    {
      to: "/link",
      img: "../../images/banner/Banner-Colgate2.webp",
  ...
  iconProducts: [
    ...
    },
    {
      to: "/product/detail",
      img: "IconHdd",
      title: "Huevos y refrigerados",
      text: "Quedan pocos días!",
      tips: "kikes",
  ...
  products: [
    {
      ...
      sku: "FAS-01",
      link: "/product/detail",
      name: "Crema dental Colgate ECONOPACKx3",
